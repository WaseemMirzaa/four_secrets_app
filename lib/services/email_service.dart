...
class EmailService {
  ...
  String buildSubscriptionEmailHtml({
    ...
    return '<html><body>'
        ...
        '<img src="https://res.cloudinary.com/dhnupmrhv/image/upload/v1767438578/STK-20260101-WA0018_2_pnl7pg.webp" '
        'alt="Ring" width="16" height="16" style="vertical-align:middle;"><br><br>'
        ...
        '<b>Kontakt:</b><br>'
        'E-Mail: <a href="mailto:4secrets-wedding@gmx.de">4secrets-wedding@gmx.de</a><br>'
        'Website: <a href="https://www.4secrets-wedding-planner.de">'
        'https://www.4secrets-wedding-planner.de</a><br><br>'
        '<br><br><br>'
